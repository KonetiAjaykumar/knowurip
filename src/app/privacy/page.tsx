    ...
    <div className="relative min-h-[calc(100vh-8rem)] bg-slate-950/90 py-12 px-4 sm:px-6 lg:px-8">
      ...
      <div className="relative z-10 max-w-3xl mx-auto space-y-12">
        ...
        <section className="text-center space-y-4">
          ...
          >
            Privacy <span className="bg-gradient-to-r from-cyan-400 to-indigo-500 bg-clip-text text-transparent">Commitment</span>
          </motion.h1>
          <motion.p
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
          ...
          {privacyPoints.map((point, index) => {
            ...
            return (
              <motion.div
                ...
                className="border border-white/10 rounded-2xl bg-slate-900/60 p-6 backdrop-blur-md flex flex-col sm:flex-row gap-5 items-start"
              >
        ...
        <motion.div
          ...
          className="border border-cyan-500/10 bg-cyan-950/5 p-6 rounded-2xl text-center space-y-4"
        >
          <CheckCircle2 className="h-8 w-8 text-cyan-400 mx-auto" />
          <h4 className="font-bold text-white text-base">GDPR & CCPA Compliant Design</h4>
