...
export default function AboutPage() {
  ...
  return (
    <div className="relative min-h-[calc(100vh-8rem)] bg-slate-950/90 py-12 px-4 sm:px-6 lg:px-8">
      ...
      <div className="relative z-10 max-w-4xl mx-auto space-y-12">
        ...
        <section className="text-center space-y-4">
          ...
          >
            Decoding <span className="bg-gradient-to-r from-cyan-400 to-indigo-500 bg-clip-text text-transparent">IP Geolocation</span>
          </motion.h1>
          <motion.p
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
        ...
        >
          ...
          <motion.div
            ...
            className="border border-white/10 rounded-2xl bg-slate-900/60 p-6 backdrop-blur-md space-y-4"
          >
            <div className="flex items-center gap-3">
              ...
              <h3 className="font-bold text-white text-lg">What is an IP Address?</h3>
            </div>
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <h3 className="font-bold text-white text-lg">IPv4 vs. IPv6</h3>
            </div>
            <p className="text-slate-300 text-sm leading-relaxed">
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <h3 className="font-bold text-white text-lg">How Geolocation Works</h3>
            </div>
            <p className="text-slate-300 text-sm leading-relaxed">
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <h3 className="font-bold text-white text-lg">ASNs and Networks</h3>
            </div>
            <p className="text-slate-300 text-sm leading-relaxed">
        ...
        <motion.div
          ...
          className="border border-cyan-500/20 bg-cyan-950/15 p-6 rounded-2xl flex flex-col sm:flex-row items-center gap-4 text-center sm:text-left"
        >
          <div className="h-12 w-12 rounded-full bg-cyan-500/10 flex items-center justify-center shrink-0">
            <Shield className="h-6 w-6 text-cyan-400" />
          </div>
          <div className="space-y-1">
            <h4 className="font-bold text-white text-base">Security Indicators & VPNs</h4>
